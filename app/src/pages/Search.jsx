import SearchSkeleton, { SearchItem } from "@/components/SearchItem";
...
function Search() {
	...
	function getProjects() {
		setLoading(true);
		ipcRenderer.invoke('search', `https://customrlmaps.com/api/project/search?query=${query}&page=${page}&order=${order}&orderType=${orderType}&type=${type}&username=${username}&rating=${rating}`)
		.then((data) => {
			if (data.error) {
