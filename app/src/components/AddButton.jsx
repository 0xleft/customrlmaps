...
export function AddButton() {
  	return (
		...
		<DropdownMenuContent className="w-56">
			...
			<DropdownMenuItem value="map" onSelect={() => {
                require("electron").shell.openExternal("https://customrlmaps.com/new?type=map");
			}}>
				<CubeIcon className="mr-2" />
				Map
			</DropdownMenuItem>
			<DropdownMenuItem value="mod" onSelect={() => {
                require("electron").shell.openExternal("https://customrlmaps.com/new?type=mod");
            }}>
